<ul class="c-sidebar-nav">
    ...
    @can('manage users')
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->is("users/*") ? "c-active" : "" }}" href="{{ route('admin.users.index') }}">
    ...
    @endcan
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link {{ request()->is("clients/*") ? "c-active" : "" }}" href="{{ route('admin.clients.index') }}">
            <i class="c-sidebar-nav-icon fas fa-fw fa-address-card"></i>
            Clients
        </a>
    </li>
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link {{ request()->is("projects/*") ? "c-active" : "" }}" href="{{ route('admin.projects.index') }}">
            <i class="c-sidebar-nav-icon fas fa-fw fa-copy"></i>
            Projects
        </a>
    </li>
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link {{ request()->is("tasks/*") ? "c-active" : "" }}" href="{{ route('admin.tasks.index') }}">
    ...
    <li class="c-sidebar-nav-item">
        <a href="#" class="c-sidebar-nav-link">
            <i class="c-sidebar-nav-icon fas fa-fw fa-sign-in-alt"></i>
            Settings
        </a>
    </li>
